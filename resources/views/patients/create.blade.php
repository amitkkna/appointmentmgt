                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('patients.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="medical_history" class="form-control @error('medical_history') is-invalid @enderror" name="medical_history" rows="4">{{ old('medical_history') }}</textarea>
